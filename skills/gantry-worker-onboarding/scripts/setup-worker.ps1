...
function Write-ManagedWorkspaceBlock {
  ...
  $blockLines = @(
    $begin
    "## Gantry registered worker roots"
    ""
    "- worker: ``$Name``"
    "- updated: $UpdatedAt"
    ""
  ...
  if (Test-Path -LiteralPath $Path) {
    ...
    $updated = @(
      ...
      ""
      "This file is maintained by Gantry's worker onboarding skill."
      ""
      $block
      ""
...
function Register-WorkerStartupTask {
  ...
  Register-ScheduledTask `
    ...
    -Principal $principal `
    -Settings $settings `
    -Description "Starts the user-approved Cursor My Machines worker for Gantry." | Out-Null
